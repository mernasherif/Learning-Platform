...
class User(db.Model):
    ...
    def get_id(self):
        return str(self.UserID)  # تم تعديلها لتكون UserID بدلاً من id
...
class Course(db.Model):
    ...
    InstructorID = db.Column(db.Integer, db.ForeignKey('user.UserID'), nullable=False)
...
class Enrollment(db.Model):
    ...
    UserID = db.Column(db.Integer, db.ForeignKey('user.UserID'), nullable=False)  # تم تعديلها لتكون UserID بدلاً من id
