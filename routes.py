...
def course_detail(course_id):
    ...
    if current_user.Role == 'Student':
        enrollment = Progress.query.filter_by(UserID=current_user.UserID,CourseID=course_id).first()
        user_review = Review.query.filter_by(UserID=current_user.UserID,CourseID=course_id).first()
    
    return render_template('course_detail.html',course=course,enrollment=enrollment,user_review=user_review)
